...
b):console.log(a))}function c(a){var c=localStorage;"sessionStorage"==a&&(c=sessionStorage);var d={setValue:function(a,b,d){c.setItem("LSCACHE-"+a,d);c.setItem(a,b)}};return{getAllCookies:function(){var a="",d,e;try{for(var f in c)c.hasOwnProperty(f)&&0!==f.indexOf("LSCACHE-")&&(d=this.getItem(f),0===f.indexOf("inqCA")&&(e=sessionStorage.getItem("sinqCA"),!isNaN(e)&&0<e&&(d=0)),a+=""+f+"="+d+";")}catch(g){b("ERROR: Storage is not available. Can't get all data.")}return a},get:function(){var a={};
...
f=";expires=Thu, 01 Jan 1970 00:00:01 GMT";e=e&&("boolean"===typeof e||"string"===typeof e&&"true"===e.toLowerCase())?" secure;":"";document.cookie=a+"="+c+f+"; "+e+" path=/"+(-1!=window.location.href.indexOf(useRootDomain)?";domain="+useRootDomain:"")},removeItem:function(a){this.setItem(a,"",-1)},clear:function(){},onUnload:function(){},version:"cookie.0.0.3"}}var e,h,f,g=null,k,l=null;return{getInstance:function(k){if("localStorage"==k)return h||(h=c("localStorage")),h;if("sessionStorage"==k)return f||
(f=c("sessionStorage")),f;if(!e){if(a())g="cookie";else{k=!1;if(/firefox/i.test(window.navigator.userAgent))try{window.localStorage&&!/(iPad|iPhone).*OS 7/i.test(navigator.userAgent)&&(localStorage.setItem("inqPc",2),k=!0)}catch(n){b("WARNING window.localStorage is not supported and chat may not be offered.",n)}k?g="localStorage":(null==l&&(l=a()||""===document.cookie?!1:!0),l&&(g="cookie"))}e="cookie"===g?d():"localStorage"===g?c():null}return e},isLocalStorageUsed:function(){return e&&"localStorage"===
...
function _executeCommandFromItems(a){if(a&&0<a.length)if("ONLOAD"===a[0])doCommandsInClientDomain([location.protocol+"//"+location.host]);else try{if(checkDataForSimplePost(a))simpleChatPost(a[0]);else try{doCommands(a)}catch(e){var b=a[3],c=a[1],d='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(e,a[0])+'");';doCommandsInClientDomain(d,b,c)}}catch(e){window.console&&window.console.error(e.message)}}
...
function doPostChatCommand(a){var b="",c=a[0],d=a[1],e=a[3],h=a[4],f=a[5],g=parseInt(a[6])||0;a=a[7];try{var k=getXMLHttpRequest();xHRsInProgress[d]=k;k.open(f?"POST":"GET",h,!0);void 0!=k.timeout?k.timeout=g:xhrTimeoutController[d]=setTimeoutXHR(g,d,xHRsInProgress);k.onreadystatechange=function(){4==k.readyState&&(xhrTimeoutController[d]&&(clearTimeout(xhrTimeoutController[d]),delete xhrTimeoutController[d]),delete xHRsInProgress[d],doCommandsInClientDomain(pepareResponseData(d,k),e,d))};a&&k.setRequestHeader("X-Protection-Id",
encodeURIComponent(a));f?(k.setRequestHeader("Content-type","application/x-www-form-urlencoded"),k.send(decodeURIComponent(f))):k.send()}catch(l){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(l,c)+'");'+b,doCommandsInClientDomain(b,e,d)}}
function doSCBR3PMCommand(a){var b="",c,b=a[0],d=a[1],e=a[2],h=a[3];try{var f=a[4],g=a[5];PersistentStorage.getInstance(a[6]).setItem(f+"_"+e,g,a[7],a[8]);c={action:"3rdPCQ"};doCommandsInClientDomain(JSON.stringify(c),h,d)}catch(k){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(k,b)+'");inqFrame.Inq.FlashPeer.set3rdPartyCookieFromQueue();\n',doCommandsInClientDomain(b,h,d)}}
function doGCBR3Command(a){var b="",c=a[0],d=a[1],e=a[2];a=a[3];if(ptStorage)try{if(e)var h=ptStorage.getItem(e),b=e+"="+h;else{var f=getAllData();""===f&&(f="inqPc=1");b=f}doCommandsInClientDomain(b,a,d)}catch(g){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(g,c)+'");'+b,doCommandsInClientDomain(b,a,d)}else doCommandsInClientDomain("no-cookie",a,d)}
function doCommitPointCommand(a){var b="",c,d=a[0],e=a[1],h=a[2];a=a[3];try{var f=unescape(ptStorage.getItem("inqVital_"+h)),g=/\bvcnt:([0-9]+)/.exec(f);g||(g=/\bvcnt":([0-9]+)/.exec(f));c={action:"W3rdCC",resp:2==g.length?g[1]:0};doCommandsInClientDomain(JSON.stringify(c),a,e)}catch(k){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(k,d)+'");'+b,doCommandsInClientDomain(b,a,e)}}
function doDumpCommand(a){var b="",c=a[0],d=a[1],e=a[3];try{var h=decodeURIComponent(a[4]),f="_rand="+Math.round(0xe8d4a51001*Math.random()).toString(36)+"&level=info&line=document.cookie: "+encodeURIComponent(""+document.cookie),g=getXMLHttpRequest();xHRsInProgress[d]=g;g.open("POST",h,!0);g.onreadystatechange=function(){4==g.readyState&&(delete xHRsInProgress[d],doCommandsInClientDomain("",e,d))};g.setRequestHeader("Content-type","application/x-www-form-urlencoded");g.send(f)}catch(k){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+
catchJsFormatter(k,c)+'");'+b,doCommandsInClientDomain(b,e,d)}}
function doPOSTBR30Command(a){var b="",c=a[0],d=a[1],e=a[3];try{var h=decodeURIComponent(a[4]),f=h.indexOf("?"),g=h.substring(0,f),g=checkSameProtocolOrigin(g),k=h.substring(f+1),l=getXMLHttpRequest();xHRsInProgress[d]=l;l.open("POST",g,!0);l.onreadystatechange=function(){4==l.readyState&&(delete xHRsInProgress[d],doCommandsInClientDomain(pepareResponseData(d,l),e,d))};var m;try{m=JSON.parse(a[5])}catch(p){}if(m&&"object"===typeof m)for(var n in m)l.setRequestHeader(n,m[n]);l.setRequestHeader("Content-type",
"application/x-www-form-urlencoded");l.send(k)}catch(p){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+catchJsFormatter(p,c)+'");'+b,console&&console.error&&console.error("Error on post operation: "+b,p),doCommandsInClientDomain(b,e,d)}}
function doPOSTJSONCommand(a){var b="",c=a[0],d=a[1],e=a[3];try{var h=decodeURIComponent(a[4]),f=h.indexOf("?"),g=h.substring(0,f),g=checkSameProtocolOrigin(g),k=h.substring(f+1),l=getXMLHttpRequest();xHRsInProgress[d]=l;l.open("POST",g,!0);l.onreadystatechange=function(){4==l.readyState&&(delete xHRsInProgress[d],doCommandsInClientDomain(pepareResponseData(d,l),e,d))};l.setRequestHeader("Content-type","application/json;charset=UTF-8");l.send(k)}catch(m){b='if (inqFrame.Inq["proxyError"]!=null)inqFrame.Inq.proxyError("'+
catchJsFormatter(m,c)+'");'+b,console&&console.error&&console.error("Error on post operation: "+b,m),doCommandsInClientDomain(b,e,d)}}
function doCobrowseCommand(a){var b,c=a[0],d=a[1],e=a[3],h=a[4];6<a.length?(a.splice(0,5),b=a.join("||")):b=a[5];try{var f=getXMLHttpRequest();xHRsInProgress[d]=f;f.open("POST",h,!0);f.onreadystatechange=function(){4==f.readyState&&(delete xHRsInProgress[d],b={resp:encodeURIComponent(f.responseText),id:d,action:"ack"},doCommandsInClientDomain(JSON.stringify(b),e,d))};f.setRequestHeader("Content-type","application/octet-stream");f.send(b)}catch(g){b={resp:c,id:d,action:"error",log:catchJsFormatter(g,
c)},doCommandsInClientDomain(JSON.stringify(b),e,d)}}function doCBAUTHCommand(a){var b,c=a[0],d=a[1],e=a[2],h=a[3];try{var f=a[4],g=a[5];ptStorage.setItem(f+"_"+e,g,a[7],a[8]);g=ptStorage.getItem(f+"_"+e);b={resp:g,id:d,action:"auth"};doCommandsInClientDomain(JSON.stringify(b),h,d)}catch(k){b={resp:c,id:d,action:"error",log:catchJsFormatter(k,c)},doCommandsInClientDomain(JSON.stringify(b),h,d)}}
function doCBCheckCommand(a){var b,c=a[0],d=a[1],e=a[2];a=a[3];try{b={resp:ptStorage.getItem("cobrowse_"+e),id:d,action:"auth"},doCommandsInClientDomain(JSON.stringify(b),a,d)}catch(h){b={resp:c,id:d,action:"error",log:catchJsFormatter(h,c)},doCommandsInClientDomain(JSON.stringify(b),a,d)}}
function doChatActiveCommand(a){try{var b=a[2],c=parseStringToBoolean(a[3]),d=1E3*parseInt(a[4]),e=a[5],h="inqCA_"+b;a=c?2:1;setChatActiveFlag(h,a,"",e);caUnloadController||(caUnloadController=new UnloadController(function(a){a=caUnloadController.get();var c=getChatActiveFlag(h);0!=a&&c==a&&(setChatActiveFlag(h,0,"",e),ptStorage.setItem("inqLT_"+b,""+(new Date).getTime(),d,e),ptStorage.onUnload())},null,a));caUnloadController.activate()}catch(f){}}
...
function getStackTrace(a){try{var b=[];try{d.dont.exist+=0}catch(n){if(!n.stack&&window.opera&&n.message){for(var c=n.message.split("\n"),d=0,e=c.length;d<e;d++)if(c[d].match(/^\s*[A-Za-z0-9\-_\$]+\(/)){var h=c[d];c[d+1]&&(h+=" at "+c[d+1],d++);b.push(h)}b.shift();b.shift();return b.join("\n\t\t")}}if(arguments&&arguments.callee&&arguments.callee.caller){for(var f=arguments.callee.caller.caller;f;){var g=""+f.toString(),k=g.indexOf("function ")+9,l=g.indexOf("(",k),m=g.substring(k,l)||"anonymous function",
c="";if(f.arguments.length)for(d=0;d<f.arguments.length;d++)c+=(0!=c.length?",":"")+formatArgument(f.arguments[d]);b.push(m+"("+c+")");f=f.caller}return"stack trace:\n\t\t"+b.join("\n\t\t")}return""}catch(n){return""}}function catchJsFormatter(a,b){try{var c="\tERROR while processing "+b+": "+a.name+" - "+a.message,c=c+("\n\t"+getStackTrace(a));return toJsString(c)}catch(d){return""}}function parseStringToBoolean(a){return"string"==typeof a?"true"==a:a}
...
function parseUrl(a){if("function"===typeof URL)return new URL(a);var b=a.match(/^(https?):\/\/([^\/:]+)(:?(\d*))/);a=b[1];var c=b[2],d=0<=c.indexOf(".")&&3<=c.split(".").length?c.split(".").slice(1).join("."):c,b=b[4]?b[4]:"http"===a?"80":"https"===a?"443":null,e=a+"://"+c;null!==b&&"80"!==b&&"443"!==b&&(e+=":"+b);return{origin:e,protocol:a,domain:d,host:c,port:b}};function UnloadController(a,b,c){this.active=!1;this.handler=a;this._value=c||null;if(b)for(var d in b)this[d]=b[d]}UnloadController.prototype.activate=function(){if(!this.onunload){this.onunload=function(a){this.isActive()&&(this.handler(a),this.deactivate())};var a=this;this._addUnloadHandler(function(b){b=b||window.event;a.onunload(b)})}this.active=!0};UnloadController.prototype.deactivate=function(){this.active=!1};UnloadController.prototype.isActive=function(){return this.active};

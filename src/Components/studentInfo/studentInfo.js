...
import {getParticularStudentInfo, getAllStudents} from "../../Actions/studentDataAction";
            ...
            <div className="student-dashboard-main-container">
                {
                    ...
                    :
                       ...
                       <div className="row" style={{height:"100%", width: "100%"}}>{
                           Object.keys(this.state.studentInfo) && Object.keys(this.state.studentInfo).length !== 0 ?
                        <div className="student-info-container col-sm-12 col-md-12 col-lg-12">
                          ...
                          <div className="student-info-name">Name: {this.state.studentInfo.name} </div>
                            </div>
                            <div className="col-sm-12 col-md-5 col-lg-5 right">
                            <div className="student-info-details">Roll No: {this.state.studentInfo.rollNo}</div>
                          {/* <div>Name: {this.state.studentInfo.name}</div> */}
                         <div className="student-info-details">Class: {this.state.studentInfo.class}</div>
                         <div className="student-info-details">Marks: {this.state.studentInfo.marks.s1 + this.state.studentInfo.marks.s2 + this.state.studentInfo.marks.s3}</div>
                            </div>
                           </div>
